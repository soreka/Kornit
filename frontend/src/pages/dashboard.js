...
function DashBoard({ filter, setFilter }) {
  ...
  const [surveyDataResponsePercentage, setsurveyDataResponsePercentage] =
    useState(null);
    ...
    <div className="dashboard">
      ...
      <Grid container className="mt-0">
        ...
        >
          <Grid item xs={4} sm={8} md={12}>
            <Typography variant="h6" className="dataTitle">
              Surveys
            </Typography>
          </Grid>
          {surveyDataResponsePercentage &&
            surveyDataResponsePercentage.data && (
              <DataBoxSurvey
                dataType={surveyDataResponsePercentage.data.dataType}
                subDataType={surveyDataResponsePercentage.data.subDataType}
                mainDataValue={
                  surveyDataResponsePercentage.data.percentageAnswered
                }
      ...
      <Grid container className="mt-0">
        ...
        >
          ...
          <DataBoxPerformance
            dataType="Impression vs. target"
            mainDataValue={dashboardData && dashboardData.totalImpressions}
            subDataValue="65%"
            boxType="Big"
            color="primary"
            handleClick={() => setExpanded(!expanded)}
            isExpanded={expanded}
            data={dashboardData && dashboardData.chartData}
          />
          <DataBoxPerformance
            dataType="Impression growth"
            mainDataValue="20%"
            subDataValue="+10pp"
            boxType="Small"
            color="secondary"
